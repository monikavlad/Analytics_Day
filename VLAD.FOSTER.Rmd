...
```
```{r}
foster$race <- recode_factor(foster$race, "White"="White", "African American" = "Black or African American", "American Indian"="American Indian or Alaska Native", "Asian" = "Asian", "Pacific Islander" = "Hawaiian or Other Pacific Islander", "Multiple Race"="More Than One Race")
levels(foster$race)
```
renaming names for race categories to preserve space on the poster
```{r}
foster$race <- recode_factor(foster$race, "White"="White", "Balck or African American" = "African American", "American Indian or Alaska Native" = "American Indian", "Asian" = "Asian", "Hawaiian or Other Pacific Islander" = "Pacific Islander", "More Than One Race" = "Multiple Race")
levels(foster$race)
```
```{r}
